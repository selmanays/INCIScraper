...
export default function LoginPageV1() {
  return (
    <div className="flex pb-8 lg:h-screen lg:pb-0">
      <div className="hidden w-1/2 bg-gradient-to-br from-indigo-600 via-purple-500 to-pink-500 lg:block">
        <div className="flex h-full items-center justify-center p-12 text-white">
          <div className="max-w-sm space-y-4 text-center">
            ...
            <h2 className="text-3xl font-bold">Organize, track, and close deals faster.</h2>
            <p className="text-sm text-white/80">
              Stay focused on your pipeline with instant access to activity timelines, team performance, and revenue insights.
            </p>
          </div>
        </div>
      </div>
