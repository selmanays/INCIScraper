      ...
      <div className="hidden w-1/2 bg-gradient-to-br from-indigo-600 via-purple-500 to-pink-500 lg:block">
        <div className="flex h-full items-center justify-center p-12 text-white">
          <div className="max-w-sm space-y-4 text-center">
            ...
            <h2 className="text-3xl font-bold">Create your workspace in minutes.</h2>
            <p className="text-sm text-white/80">
              Build collaborative sales funnels, share dashboards with your team, and keep every lead moving forward.
            </p>
          </div>
        </div>
      </div>
